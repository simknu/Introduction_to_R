...
i) Load the file `tree_growth_data.csv` from the folder `01_Data` and give it 
a name (e.g. `my_table`)
...
### 4. Load and save a .csv-file
Check the R-file `02_Load_and_save_data.R` in the `03_Scripts` folder or check
the functions `read.csv` (`?read.csv`) and `write.csv` (`?write.csv`).  
